---
sidebar_position: 7
description: Generate an HTML scan report artifact from PIM Monitor. Enable the report and publish it as a pipeline artifact.
---
...
- [Notifications](./notifications.md): email and webhook alternatives
